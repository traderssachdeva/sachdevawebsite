        ...
        >
          <div className="flex lg:flex-1">
            <a href="#home" className="-m-1.5 p-1.5">
              <img className="h-10 w-10 " src="/logo8.png" alt="" />
            </a>
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Announcing our next round of collections.{" "}
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-justify max-w-xs md:max-w-3xl mx-auto text-[16px] capitalize  text-black">
              ...
              modern milling techniques to ensure that every grain is packed
