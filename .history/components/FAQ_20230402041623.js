...
export default function FAQ() {
  return (
    <div className=" bg-black/90">
      <h2 className="text-4xl md:text-4xl lg:text-5xl   capitalize mb-8 text-center text-white">
        why to choose us ?
      </h2>
          ...
          <div key={keyfeature.id}>
            <div className="max-w-xs flex flex-col  md:flex-row    mx-auto  my-8 overflow-hidden md:max-w-sm rounded-md cursor-pointer">
              <div className=" flex flex-col md:flex-col   justify-center items-center mx-auto">
                <div className="">
                  <a className="block mt-1 text-lg leading-tight font-medium text-white/90 hover:underline">
                    {keyfeature.name}
                  </a>
