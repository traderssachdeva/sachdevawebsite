...
const keyfeatures = [
  {
    id: 1,
    name: "How is your rice produced? What farming methods do you use?",
  ...
  {
    id: 5,
    name: " Can you tell me more about the different types of rice you offer? ",
          ...
          <div key={keyfeature.id}>
            <div className="max-w-xs flex flex-col  md:flex-row    mx-auto  my-8 overflow-hidden md:max-w-sm rounded-md cursor-pointer">
              <div className=" flex flex-col md:flex-col   justify-center items-center mx-auto">
                <div className="">
                  <a className="block mt-1 text-xl  text-gray-200 ">
                    {keyfeature.name}
                  </a>
