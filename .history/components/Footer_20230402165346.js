...
function Footer() {
  return (
    <div>
      <footer className="bg-white   text-black/70  ">
        <div className="grid  text-black/80  px-32 gap-8   grid-cols-1 space-y-8  md:space-y-0  py-8 md:grid-cols-3">
          <div>
            <h2 className="mb-6 uppercase   text-sm font-semibold ">
              Sachdeva Traders
            </h2>
            <ul className=" ">
              <li className="mb-4">
        ...
        <div className=" flex flex-col py-6  border-gray-100 border-t   md:flex md:flex-row px-24 md:items-center md:justify-between justify-center">
          <span className="text-sm    tracking-wide text-center text-black/80 sm:text-center">
            © Sachdeva Traders™ 2023 | All rights reserved.
          </span>
