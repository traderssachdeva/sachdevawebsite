...
function ContactUs() {
  return (
    <section className="min-h-screen overflow-hidden bg-white dark:bg-gray-900">
        ...
        <div className="lg:flex lg:items-center lg:-mx-10">
          <div className="lg:w-1/2 lg:mx-10">
            ...
            <p className="mt-4 text-gray-500 dark:text-gray-400">
              Thank you for your interest in our rice enterprise! If you have
              any questions, comments, or feedback, please don't hesitate to
              contact us. Our team is available to assist you in any way we can.
            </p>
